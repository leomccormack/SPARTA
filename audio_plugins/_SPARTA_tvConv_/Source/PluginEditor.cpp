...
void PluginEditor::paint (juce::Graphics& g)
{
...

    {
        ...
        juce::String text (TRANS("6DoF Covolver"));
...
void PluginEditor::timerCallback()
{
    ...
    label_NFilters->setText(String(tvconv_getNIRs(hTVC)), dontSendNotification);
    ...
    label_MatrixNInputs->setText(String(tvconv_getNumInputChannels(hTVC)), dontSendNotification);
    label_MatrixNoutputs->setText(String(tvconv_getNumOutputChannels(hTVC)), dontSendNotification);
    label_NOutputs->setText(String(tvconv_getNumOutputChannels(hTVC)), dontSendNotification);
...
<JUCER_COMPONENT documentType="Component" className="PluginEditor" componentName=""
  ...
  <BACKGROUND backgroundColour="ffffffff">
    ...
    <TEXT pos="92 1 124 32" fill="solid: ffe9ff00" hasStroke="0" text="6DoF Covolver"
