...
void PluginProcessor::oscMessageReceived(const OSCMessage& message)
{
    ...
    if (message.size() == 3 && message.getAddressPattern().toString().compare("xyz")) {
        if (message[0].isFloat32())
            transData.x = message[0].getFloat32();
        if (message[1].isFloat32())
            transData.y = message[1].getFloat32();
        if (message[2].isFloat32())
            transData.z = message[2].getFloat32();
        return;
    }
        ...
        if (message[2].isFloat32())
            transData.z = message[2].getFloat32();
        if (message[3].isFloat32())
            transData.yaw = message[3].getFloat32();
        if (message[4].isFloat32())
            transData.pitch = message[4].getFloat32();
        if (message[5].isFloat32())
            transData.roll = message[5].getFloat32();
...
{
    return transData.yaw;
}

float PluginProcessor::getPitch()
{
    return transData.pitch;
}

float PluginProcessor::getRoll()
{
    return transData.roll;
}
