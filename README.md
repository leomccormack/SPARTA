...
* **AmbiRoomSim** - An Ambisonic encoder that also includes reflections based on the image-source method using a shoebox room model. Multiple sources and multiple receivers are supported up to 64 channels (16x 1st-order, 4x 3rd-order, or 1x 7th order receiver).
